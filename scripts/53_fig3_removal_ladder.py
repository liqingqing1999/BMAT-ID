...
# the baseline annotation hugs the left end of its own dotted line; the panel is
# given enough head-room that the legend sits in a band above every text object
...
ax.set_xlim(-350, 7600); ax.set_ylim(-140, 3600)

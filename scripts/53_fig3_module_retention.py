## Figure 3 - which programmes survive adipogenic culture
...
fig.savefig(FIG + "BMATID_Fig3_module_retention.png", dpi=300, facecolor="white")
fig.savefig(FIG + "BMATID_Fig3_module_retention.pdf", facecolor="white")
say("\nwrote BMATID_Fig3_module_retention.png/.pdf")
say("DONE")
log.close()

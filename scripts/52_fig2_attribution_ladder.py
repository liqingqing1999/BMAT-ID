## Figure 2 - the composition-attribution ladder
...
fig.savefig(FIG + "BMATID_Fig2_attribution_ladder.png", dpi=300, facecolor="white")
fig.savefig(FIG + "BMATID_Fig2_attribution_ladder.pdf", facecolor="white")
say("\nwrote BMATID_Fig2_attribution_ladder.png/.pdf")
